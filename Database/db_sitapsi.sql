...
-- ================================================================
    ...
    CREATE TABLE tb_feedback_ortu (
        ...
        id_sp INT NULL, -- Mengikat ke SP tertentu
        id_transaksi BIGINT NULL, -- Mengikat ke transaksi pelanggaran tertentu
...
-- INSERT GURU
-- GURU (Lengkap dengan Jabatan & Mapel)
INSERT INTO tb_guru (nama_guru, nip, kode_guru, is_walikelas, id_kelas, pin_validasi, email, mapel, homebase, isBK) VALUES 
('Sr. M. Elfrida Suhartati, SPM, S.Psi.,MM', '10001', '1', 'Ya', 1, '123456', 'guru1@sekolah.id', '-', '-', 0),
('Antonetta Maria Kuntodiati, S.Pd', '10002', '2', 'Ya', 2, '123456', 'guru2@sekolah.id', 'Ilmu Pengetahuan Alam (IX)', 'Lab Fisika', 0),
('Dra. Maria Marsiti', '10003', '3', 'Ya', 3, '123456', 'guru3@sekolah.id', 'Bimbingan Konseling (IX), Bahasa Daerah (VII, VIII, IX)', 'Tidak ada', 0),
('Trianto Thomas, S.Pd', '10004', '4', 'Ya', 4, '123456', 'guru4@sekolah.id', 'Bahasa Indonesia (IX)', 'Ruang B. Indonesia 9', 0),
('Agustina Peni Sarasati, S.Pd', '10005', '5', 'Ya', 5, '123456', 'guru5@sekolah.id', 'Matematika (VII)', 'Ruang Matematika 7', 0),
('Y. Pamungkas, S.Pd', '10006', '6', 'Ya', 6, '123456', 'guru6@sekolah.id', 'Ilmu Pengetahuan Sosial (VII, VIII)', 'Ruang Geografi', 0),
('Joseph Andiek Kristian, S.Pd, S.Kom', '10007', '7', 'Ya', 7, '123456', 'guru7@sekolah.id', 'Informatika (VIII, IX)', 'Laboratorium Komputer', 0),
('Albertha Yulanti Susetyo, M.Pd', '10008', '8', 'Ya', 8, '123456', 'guru8@sekolah.id', 'Matematika (IX)', 'Ruang Matematika 9', 0),
('Galang Bagus Afridianto, M.Pd', '10009', '9', 'Ya', 9, '123456', 'guru9@sekolah.id', 'Ilmu Pengetahuan Sosial (VIII, IX)', 'Ruang IPS', 0),
('Hendrik Kiswanto, S.Pd.', '10010', '10', 'Ya', 10, '123456', 'guru10@sekolah.id', 'Seni Budaya (VII, VIII, IX)', 'Ruang Prakarya', 0),
('Margareta Esti Wulan, S.Pd.', '10011', '11', 'Ya', 11, '123456', 'guru11@sekolah.id', 'Ilmu Pengetahuan Alam (VIII)', 'Lab Biologi', 0),
('Theresia Sri Wahyuni, S.Pd, M.M.', '10012', '12', 'Ya', 12, '123456', 'guru12@sekolah.id', 'Bimbingan Konseling (VII, VIII)', 'Tidak ada', 0),
('Yosua Beni Setiawan, S.Pd.', '10014', '14', 'Ya', 13, '123456', 'guru14@sekolah.id', 'Bahasa Inggris (VIII)', 'Tidak ada', 0),
('God Life Endob Mesak, S.Pd', '10015', '15', 'Ya', 14, '123456', 'guru15@sekolah.id', 'Pendidikan Jasmani Olahraga dan Kesehatan (VIII, IX)', 'Tidak ada', 0),
('Agnes Herawaty Sinurat, S.E., M.M.', '10016', '16', 'Ya', 15, '123456', 'guru16@sekolah.id', 'Ilmu Pengetahuan Sosial (VII), Pendidikan Kewarganegaraan (VIII, IX)', 'Ruang Kewarganegaraan', 0),
